...
- Any backwards-compatibility shims, defensive code, or unnecessary
  deduplication.
...
After printing out your findings, fix them.
...
Continue to do that in a loop (look over the code again, find new cleanups that
are visible now that you've fixed the last ones, print them out, and fix them)
until you find no more cleanups to do upon reinspection.
