...
class Mover(literal.Action):
    ...
    def run(self, destruction_contracts: MoverDestructionContracts = _DEFAULT_DESTRUCTION_CONTRACTS):
        ...
        literal.record_operation("mover.move(/caller_parent, caller_destination)")
        ...
        literal.record_operation("mover.destroy(discard)")
        ...
        literal.record_operation("mover.destroy(guaranteed_destination)")
        ...
        literal.record_operation("mover.destroy(caller_destination)")
        ...
        literal.record_operation("mover.destroy(trigger_pos)")
