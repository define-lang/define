...
class MiddleDestructionContracts:
    def run_destructors_position_gw__position_holder(self, _particle: literal.Particle):
        pass

    def destroy_position_gw__position_holder(self, _particle: literal.Particle):
        pass
...
class Middle(literal.Action):
    ...
    def run(self, destruction_contracts: MiddleDestructionContracts = _DEFAULT_DESTRUCTION_CONTRACTS):
        ...
        literal.record_operation("middle.move(gw::/holder, gw::/inner::holder)")
        self.get_interface_position(
            "position<gw>"
        ).particle.get_action(
            local.my_domain_com.my_lib.inner.Inner
        ...
        destruction_contracts.run_destructors_position_gw__position_holder(
            self.get_interface_position(
                "position<gw>"
            ).particle.get_action(
                local.my_domain_com.my_lib.inner.Inner
        ...
        destruction_contracts.destroy_position_gw__position_holder(
            self.get_interface_position(
                "position<gw>"
            ).particle.get_action(
                local.my_domain_com.my_lib.inner.Inner
        ...
        literal.record_operation("middle.destroy(gw::/inner::holder)")
        self.get_interface_position(
            "position<gw>"
        ).particle.get_action(
            local.my_domain_com.my_lib.inner.Inner
