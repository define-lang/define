...
class Other(literal.Action):
    ...
    def run(self, destruction_contracts: OtherDestructionContracts = _DEFAULT_DESTRUCTION_CONTRACTS):
        ...
        literal.record_operation("other.move(/input::/start, /input::/middle)")
        self.on_particle.get_position(
            local.my_domain_com.my_lib.input.Input
        ).particle.get_position(
            local.my_domain_com.my_lib.middle.Middle
        ...
        literal.record_operation("other.move(/input::/middle, /input::/target)")
        self.on_particle.get_position(
            local.my_domain_com.my_lib.input.Input
        ).particle.get_position(
            local.my_domain_com.my_lib.target.Target
        ...
        literal.record_operation("other.move(/input::/target, holder)")
        ...
        literal.record_operation("other.destroy(holder)")
