...
class TriggeredDestructionContracts:
    def run_destructors_global_position_implied(self, _particle: literal.Particle):
        pass

    def destroy_global_position_implied(self, _particle: literal.Particle):
        pass
...
class Triggered(literal.Action):
    ...
    def run(self, destruction_contracts: TriggeredDestructionContracts = _DEFAULT_DESTRUCTION_CONTRACTS):
        ...
        literal.record_operation("triggered.destroy(/implied)")
