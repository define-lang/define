...
class WorkerDestructionContracts:
    ...
    def run_destructors_position_reserve(self, _particle: literal.Particle):
        pass

    def destroy_position_reserve(self, _particle: literal.Particle):
        pass
...
class Worker(literal.Action):
    ...
    def __init__(self, on_particle: literal.Particle):
        super().__init__(
            ...
            interface_positions=[
                ...
                literal.LocalPosition("position<reserve>"),
    ...
    def run(self, destruction_contracts: WorkerDestructionContracts = _DEFAULT_DESTRUCTION_CONTRACTS):
        ...
        literal.record_operation("worker.move(reserve, input)")
        destruction_contracts.run_destructors_position_reserve(
            self.get_interface_position(
                "position<input>"
            ).particle
        )
