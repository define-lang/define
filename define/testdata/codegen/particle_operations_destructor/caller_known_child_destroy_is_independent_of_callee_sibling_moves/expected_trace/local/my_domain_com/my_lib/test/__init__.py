...
class TestExecution:
    def __init__(
        ...
        self.execution_action_destroyer.join_for_move_position_run_to_position_incoming = literal.NO_JOIN
    ...
    def create_position_source__global_position_extra(self):
        self.local_position_source.particle.get_position(
            local.my_domain_com.my_lib.extra.Extra
        ).create_particle()
        self.scheduler.operation_completed(
