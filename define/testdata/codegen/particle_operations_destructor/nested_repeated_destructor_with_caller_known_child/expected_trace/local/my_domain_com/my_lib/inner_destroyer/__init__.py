...
class InnerDestroyerDestructionContracts:
...
class InnerDestroyer(literal.Action):
    ...
    @override
    def run(self, destruction_contracts: InnerDestroyerDestructionContracts = _DEFAULT_DESTRUCTION_CONTRACTS):
        ...
        literal.record_operation("inner_destroyer.destroy(target)")
