...
class TestExecution:
    def __init__(
        ...
        self.join_for_move_position_source_to_position_box__action_middle__position_gw__action_inner__position_slot = literal.Join(2)
        ...
        self.join_for_trigger_position_box__action_middle__for_empty_rule_position_gw__action_inner__position_slot = literal.Join(2)
