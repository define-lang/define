...
class TestExecution:
    def __init__(
        ...
        self.join_for_move_position_source_to_position_box__action_middle__position_gw__action_inner__position_slot = self.scheduler.create_join(2)
        ...
        self.join_for_trigger_position_box__action_middle__for_empty_rule_position_gw__action_inner__position_slot = self.scheduler.create_join(2)

    def create_position_source(self):
        self.action.get_interface_position(
            "position<source>"
        ).create_particle()
        self.move_position_source_to_position_box__action_middle__position_gw__action_inner__position_slot()
    ...
    def create_position_box__action_middle__position_gw(self):
        ...
        self.scheduler.submit(self.move_position_source_to_position_box__action_middle__position_gw__action_inner__position_slot)
        self.trigger_position_box__action_middle__when_empty_position_gw__action_inner__position_trigger_pos()

    def move_position_source_to_position_box__action_middle__position_gw__action_inner__position_slot(self):
        if not self.join_for_move_position_source_to_position_box__action_middle__position_gw__action_inner__position_slot.arrive():
            return
        self.action.get_interface_position(
            "position<source>"
        ).move_particle_to(
        ...
        self.trigger_position_box__action_middle__for_empty_rule_position_gw__action_inner__position_slot()
    ...
    def trigger_position_box__action_middle__for_empty_rule_position_gw__action_inner__position_slot(self):
        if not self.join_for_trigger_position_box__action_middle__for_empty_rule_position_gw__action_inner__position_slot.arrive():
            return
        self.execution_trigger_position_box__action_middle.accept_for_empty_rule_position_gw__action_inner__position_slot()
