...
class TestExecution:
    ...
    def move_position_source_to_action_destroyer__position_run(self):
        ...
        self.scheduler.submit(self.trigger_action_destroyer__for_empty_rule_position_run)
        self.trigger_action_destroyer__when_empty_global_position_destination()
    ...
    def trigger_action_destroyer__when_empty_global_position_destination(self):
        self.execution_trigger_action_destroyer.accept_when_empty_global_position_destination()
