...
class TestExecution:
    def __init__(
        ...
        self.join_for_trigger_position_box__action_middle__for_empty_rule_position_gw__action_inner__position_holder__global_position_a = self.scheduler.create_join(2)
    ...
    def create_position_box__action_middle__position_gw(self):
        ...
        self.scheduler.submit(self.create_position_box__action_middle__position_gw__action_inner__position_holder)
        self.trigger_position_box__action_middle__when_empty_position_gw__action_inner__position_trigger_pos()

    def create_position_box__action_middle__position_gw__action_inner__position_holder(self):
        self.action.get_interface_position(
            "position<box>"
        ).particle.get_action(
            local.my_domain_com.my_lib.middle.Middle
        ...
        self.trigger_position_box__action_middle__for_empty_rule_position_gw__action_inner__position_holder__global_position_a()
    ...
    def create_position_box__action_middle__position_trigger_pos(self):
        ...
        self.scheduler.submit(self.trigger_position_box__action_middle__for_empty_rule_position_gw__action_inner__position_holder__global_position_a)
        self.trigger_position_box__action_middle__when_empty_position_gw__action_inner__position_trigger_pos()

    def trigger_position_box__action_middle__for_empty_rule_position_gw__action_inner__position_holder__global_position_a(self):
        if not self.join_for_trigger_position_box__action_middle__for_empty_rule_position_gw__action_inner__position_holder__global_position_a.arrive():
            return
        self.execution_trigger_position_box__action_middle.accept_for_empty_rule_position_gw__action_inner__position_holder__global_position_a()
