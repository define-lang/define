...
class TestExecution:
    def __init__(
        ...
        self.destruction_connection_trigger_global_action_middle_2: tracing.DestructionConnection
    ...
    def destroy_global_position_parent__global_position_sibling(self):
        ...
        self.scheduler.destroy_completed(
            self.destruction_connection_trigger_global_action_middle_2.trace_execution,
            "/parent::/sibling",
            1,
        )
