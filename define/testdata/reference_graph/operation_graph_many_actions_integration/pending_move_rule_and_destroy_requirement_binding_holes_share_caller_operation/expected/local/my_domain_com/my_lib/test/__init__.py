...
class TestExecution:
    def __init__(
        ...
        self.join_for_trigger_position_gateway__action_worker__for_empty_rule_position_occupied = literal.Join(2)
        self.join_for_trigger_position_gateway__action_worker__for_empty_rule_position_source = literal.Join(3)
