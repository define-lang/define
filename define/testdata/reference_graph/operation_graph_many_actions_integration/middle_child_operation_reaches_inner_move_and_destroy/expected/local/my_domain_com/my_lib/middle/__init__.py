...
class MiddleExecution:
    ...
    def create_position_gateway__action_inner__position_trigger_pos(self):
        ...
        self.init_execution_trigger_position_gateway__action_inner()
        self.scheduler.submit_all(self.guarantees.guarantee_position_gateway__action_inner__position_trigger_pos)
        self.trigger_position_gateway__action_inner__for_empty_rule_position_source()

    def init_execution_trigger_position_gateway__action_inner(self):
