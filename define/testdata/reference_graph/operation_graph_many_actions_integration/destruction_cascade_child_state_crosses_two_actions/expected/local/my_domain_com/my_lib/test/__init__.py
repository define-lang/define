...
class TestExecution:
    def __init__(
        ...
        self.execution_action_middle = local.my_domain_com.my_lib.middle.MiddleExecution(
            ...
            {
                local.my_domain_com.my_lib.inner.InnerExecution.continue_destroy_position_inner_run: self.destruction_connection_action_middle,
            },
            ),
        )
        self.execution_action_middle.join_for_empty_rule_position_run = literal.NO_JOIN
        self.execution_action_middle.join_for_move_position_run_to_action_inner__position_inner_run = literal.NO_JOIN
