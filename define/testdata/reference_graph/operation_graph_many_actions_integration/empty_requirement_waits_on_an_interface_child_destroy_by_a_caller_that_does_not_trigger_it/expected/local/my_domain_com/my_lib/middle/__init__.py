...
class MiddleExecution:
    def __init__(
        ...
        self.join_for_trigger_position_gw__action_inner__when_empty_position_holder__global_position_a = literal.Join(2)
    ...
    def accept_when_empty_position_gw__action_inner__position_holder__global_position_a(self):
