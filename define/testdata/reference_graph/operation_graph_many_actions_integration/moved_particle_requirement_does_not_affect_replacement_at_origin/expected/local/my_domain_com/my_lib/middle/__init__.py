...
class MiddleGuarantees:
    def __init__(self):
        ...
        self.guarantee_position_holder__action_inner__position_trigger_pos: list[literal.Task] = []
        self.trigger_position_holder__action_inner = local.my_domain_com.my_lib.inner.InnerGuarantees()
...
class MiddleExecution:
    ...
    def move_position_source_to_position_holder(self):
        ...
        self.scheduler.submit(self.create_position_holder__action_inner__position_trigger_pos)
        self.scheduler.submit(self.trigger_position_holder__action_inner__for_empty_rule_position_item)
    ...
    def create_position_holder__action_inner__position_trigger_pos(self):
        self.action.get_interface_position(
            "position<holder>"
        ).particle.get_action(
            local.my_domain_com.my_lib.inner.Inner
    ...
    def trigger_position_holder__action_inner__for_empty_rule_position_item(self):
        if not self.join_for_trigger_position_holder__action_inner__for_empty_rule_position_item.arrive():
            return
        self.execution_trigger_position_holder__action_inner.accept_for_empty_rule_position_item()
