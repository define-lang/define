...
class TestExecution:
    ...
    def create_position_box__action_middle__position_gw(self):
        ...
        self.scheduler.submit(self.create_position_box__action_middle__position_gw__action_inner__position_slot)
        self.trigger_position_box__action_middle__when_empty_position_gw__action_inner__position_trigger_pos()

    def create_position_box__action_middle__position_gw__action_inner__position_slot(self):
        self.action.get_interface_position(
            "position<box>"
        ).particle.get_action(
            local.my_domain_com.my_lib.middle.Middle
    ...
    def create_position_box__action_middle__position_trigger_pos(self):
        ...
        self.scheduler.submit(self.trigger_position_box__action_middle__for_empty_rule_position_gw__action_inner__position_slot)
        self.trigger_position_box__action_middle__when_empty_position_gw__action_inner__position_trigger_pos()
