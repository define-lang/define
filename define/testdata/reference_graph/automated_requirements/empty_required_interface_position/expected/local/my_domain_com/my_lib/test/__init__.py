...
class TestExecution:
    ...
    def create_global_action_runner__position_run(self):
        ...
        self.trigger_global_action_runner__when_empty_position_output()
    ...
    def trigger_global_action_runner__when_empty_position_output(self):
        self.trigger_global_action_runner__execution.accept_when_empty_position_output()
