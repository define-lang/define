...
class TestExecution:
    def __init__(
        ...
        self.execution_action_runner.join_for_move_position_source_to_position_dest = literal.NO_JOIN
    ...
    def accept_when_empty_action_runner__position_dest(self):
        if not self.join_when_empty_action_runner__position_dest.arrive():
            return
        self.execution_action_runner.accept_for_empty_rule_position_source()
