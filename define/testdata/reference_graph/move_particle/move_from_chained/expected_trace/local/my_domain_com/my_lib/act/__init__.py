...
class Act(literal.Action):
    ...
    def run(self, destruction_contracts: ActDestructionContracts = _DEFAULT_DESTRUCTION_CONTRACTS):
        ...
        literal.record_operation("act.move(chain_src_a::/mid_src_a::/end_src_a, local_dest)")
        self.get_interface_position(
            "position<chain_src_b>"
        ).particle.get_position(
            local.my_domain_com.my_lib.mid_src_b.MidSrcB
        ...
        literal.record_operation("act.move(chain_src_b::/mid_src_b::/end_src_b, iface_dest)")
        self.get_interface_position(
            "position<chain_src_c>"
        ).particle.get_position(
            local.my_domain_com.my_lib.mid_src_c.MidSrcC
        ...
        literal.record_operation("act.destroy(chain_src_a::/mid_src_a)")
        self.get_interface_position(
            "position<chain_src_a>"
        ).destroy_particle()
        ...
        literal.record_operation("act.destroy(chain_src_b::/mid_src_b)")
        self.get_interface_position(
            "position<chain_src_b>"
        ).destroy_particle()
        ...
        literal.record_operation("act.destroy(chain_src_c::/mid_src_c)")
        self.get_interface_position(
            "position<chain_src_c>"
        ).destroy_particle()
        literal.record_operation("act.destroy(chain_src_c)")
