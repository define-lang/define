...
class TestExecution:
    def __init__(
        ...
        self.destruction_position_position_gateway__action_other__position_slot: literal.Position
        self.destruction_position_position_gateway__action_other__position_slot_2: literal.Position
    ...
    def create_position_gateway(self):
        ...
        self.execution_position_gateway__action_other.guarantees.position_slot.inits.append(
            self.init_position_gateway__action_other__position_slot
        )
        self.execution_position_gateway__action_other.guarantees.position_slot.consumers.append(
        ...
        self.execution_position_gateway__action_other_2.guarantees.position_slot.inits.append(
            self.init_position_gateway__action_other__position_slot_2
        )
        self.execution_position_gateway__action_other_2.guarantees.position_slot.consumers.append(
            self.destroy_position_gateway__action_other__position_slot_2
        )
        ...
        self.scheduler.continue_with(
            ...
            self.execution_position_gateway__action_other.accept_when_empty_position_slot,
        )
    ...
    def destroy_position_gateway__action_other__position_slot(self):
        self.destruction_position_position_gateway__action_other__position_slot.destroy_particle()
        self.execution_position_gateway__action_other_2.accept_when_empty_position_slot()
    ...
    def destroy_position_gateway__action_other__position_slot_2(self):
        self.destruction_position_position_gateway__action_other__position_slot_2.destroy_particle()
        self.destroy_position_gateway()
    ...
    def init_position_gateway__action_other__position_slot(self):
        self.destruction_position_position_gateway__action_other__position_slot = self.local_position_gateway.particle.get_action(
            local.my_domain_com.my_lib.other.Other
        ).get_interface_position(
            "position<slot>"
        )

    def init_position_gateway__action_other__position_slot_2(self):
        self.destruction_position_position_gateway__action_other__position_slot_2 = self.local_position_gateway.particle.get_action(
            local.my_domain_com.my_lib.other.Other
        ).get_interface_position(
            "position<slot>"
        )
