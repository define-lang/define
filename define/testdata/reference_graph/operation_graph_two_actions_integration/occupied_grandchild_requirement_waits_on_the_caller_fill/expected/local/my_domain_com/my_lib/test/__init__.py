...
class TestExecution:
    def __init__(
        ...
        self.join_for_trigger_position_gateway__global_action_other__for_empty_rule_position_box__global_position_child__global_position_grandchild = literal.Join(2)
    ...
    def create_position_gateway__global_action_other__position_box(self):
        ...
        self.trigger_position_gateway__global_action_other__for_empty_rule_position_box__global_position_child__global_position_grandchild()
    ...
    def trigger_position_gateway__global_action_other__for_empty_rule_position_box__global_position_child__global_position_grandchild(self):
        if not self.join_for_trigger_position_gateway__global_action_other__for_empty_rule_position_box__global_position_child__global_position_grandchild.arrive():
            return
        self.trigger_position_gateway__global_action_other__execution.accept_for_empty_rule_position_box__global_position_child__global_position_grandchild()
