...
class TestExecution:
    def __init__(
        ...
        self.join_for_trigger_position_gateway__global_action_other__when_empty_position_slot = literal.Join(2)

    def create_position_gateway(self):
        self.action.get_interface_position(
            "position<gateway>"
        ).create_particle()
        self.scheduler.submit(self.create_position_gateway__global_action_other__position_slot)
        self.create_position_gateway__global_action_other__position_trigger_pos()

    def create_position_gateway__global_action_other__position_slot(self):
        self.action.get_interface_position(
            "position<gateway>"
        ).particle.get_action(
            local.my_domain_com.my_lib.other.Other
        ...
        self.trigger_position_gateway__global_action_other__when_empty_position_slot()
    ...
    def trigger_position_gateway__global_action_other__when_empty_position_slot(self):
        if not self.join_for_trigger_position_gateway__global_action_other__when_empty_position_slot.arrive():
            return
        self.trigger_position_gateway__global_action_other__execution.accept_when_empty_position_slot()
