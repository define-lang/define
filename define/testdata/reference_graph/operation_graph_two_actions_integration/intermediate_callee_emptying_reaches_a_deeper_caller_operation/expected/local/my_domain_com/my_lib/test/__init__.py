...
class TestExecution:
    ...
    def create_position_gateway(self):
        ...
        self.execution_position_gateway__action_other.join_for_destroy_position_parent__global_position_child = literal.NO_JOIN
        self.execution_position_gateway__action_other.join_for_destroy_position_parent = literal.NO_JOIN
