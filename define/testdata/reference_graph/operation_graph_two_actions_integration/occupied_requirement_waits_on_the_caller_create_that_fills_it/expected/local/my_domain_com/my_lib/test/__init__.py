...
class TestExecution:
    def __init__(
        ...
        guarantees.trigger_position_gateway__action_other.guarantee_position_input.append(
        ...
        self.join_for_trigger_position_gateway__action_other__for_empty_rule_position_input = self.scheduler.create_join(2)
    ...
    def create_position_gateway__action_other__position_input(self):
        ...
        self.trigger_position_gateway__action_other__for_empty_rule_position_input()
    ...
    def trigger_position_gateway__action_other__for_empty_rule_position_input(self):
        if not self.join_for_trigger_position_gateway__action_other__for_empty_rule_position_input.arrive():
            return
        self.execution_trigger_position_gateway__action_other.accept_for_empty_rule_position_input()
