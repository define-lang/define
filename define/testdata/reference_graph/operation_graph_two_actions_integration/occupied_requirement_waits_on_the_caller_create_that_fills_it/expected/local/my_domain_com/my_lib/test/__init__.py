...
class TestExecution:
    def __init__(
        ...
        self.join_for_trigger_position_gateway__global_action_other__for_empty_rule_position_input = literal.Join(2)
    ...
    def create_position_gateway__global_action_other__position_input(self):
        ...
        self.trigger_position_gateway__global_action_other__for_empty_rule_position_input()
    ...
    def trigger_position_gateway__global_action_other__for_empty_rule_position_input(self):
        if not self.join_for_trigger_position_gateway__global_action_other__for_empty_rule_position_input.arrive():
            return
        self.trigger_position_gateway__global_action_other__execution.accept_for_empty_rule_position_input()
