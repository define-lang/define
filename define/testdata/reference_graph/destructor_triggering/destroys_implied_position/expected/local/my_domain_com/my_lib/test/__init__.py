...
class TestExecution:
    def __init__(
        ...
        self.join_for_trigger_position_box__global_action_destructor__when_empty_global_position_marker = literal.Join(2)
    ...
    def create_position_box(self):
        ...
        self.scheduler.submit(self.trigger_position_box__global_action_destructor__when_empty_global_position_marker)
        self.trigger_position_box__global_action_destructor__when_empty_global_position_marker()
    ...
    def trigger_position_box__global_action_destructor__when_empty_global_position_marker(self):
        if not self.join_for_trigger_position_box__global_action_destructor__when_empty_global_position_marker.arrive():
            return
        self.trigger_position_box__global_action_destructor__execution.accept_when_empty_global_position_marker()
