...
class CloseThingDestructionContracts:
...
class CloseThing(literal.Action):
    ...
    @override
    def run(self, destruction_contracts: CloseThingDestructionContracts = _DEFAULT_DESTRUCTION_CONTRACTS):
        ...
        literal.record_operation("close_thing.destroy(target)")
