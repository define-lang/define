...
class TestExecution:
    def __init__(
        ...
        self.destruction_connection_action_destroyer = tracing.DestructionConnection(
            ...
            self.run_action_destroyer__position_run__global_position_extra__action_child_destruct,
        )
        self.execution_action_destroyer = local.my_domain_com.my_lib.destroyer.DestroyerExecution(
    ...
    def run_action_destroyer__position_run__global_position_extra__action_child_destruct(self):
