...
class ExtraDestructorGuarantees:
    def __init__(self):
        self.global_position_empty_marker__move__global_position_marker = literal.Guarantee()
...
class ExtraDestructorExecution:
    ...
    def move_global_position_marker_to_global_position_empty_marker(self):
        ...
        self.guarantees.global_position_empty_marker__move__global_position_marker.publish(
            self.scheduler,
        )
