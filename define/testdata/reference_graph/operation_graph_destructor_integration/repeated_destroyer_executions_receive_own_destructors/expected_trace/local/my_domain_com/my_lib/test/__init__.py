...
class TestExecution:
    def __init__(
        ...
        self.execution_action_destroyer_3: local.my_domain_com.my_lib.destroyer.DestroyerExecution
        self.destruction_connection_action_destroyer_3: tracing.DestructionConnection
        self.execution_action_destroyer_4: local.my_domain_com.my_lib.destroyer.DestroyerExecution
        ...
        self.destruction_connection_action_destroyer = tracing.DestructionConnection(
            self.scheduler,
            0,
            self.run_action_destroyer__position_target__action_destructor_a,
        )
        self.execution_action_destroyer = local.my_domain_com.my_lib.destroyer.DestroyerExecution(
        ...
        self.execution_action_destroyer.guarantees.position_target.consumers.append(
            self.move_position_a_and_b_to_action_destroyer__position_target
        )
        self.destruction_connection_action_destroyer_2 = tracing.DestructionConnection(
            self.scheduler,
            0,
            self.run_action_destroyer__position_target__action_destructor_b,
            self.run_action_destroyer__position_target__action_destructor_a_2,
        )
        self.execution_action_destroyer_2 = local.my_domain_com.my_lib.destroyer.DestroyerExecution(
            self.action.on_particle.get_action(
                local.my_domain_com.my_lib.destroyer.Destroyer
        ...
        self.execution_action_destroyer_2.join_for_empty_rule_position_target = literal.NO_JOIN
        self.execution_action_destroyer_2.join_for_destroy_position_target = literal.NO_JOIN
        self.execution_action_destroyer_2.guarantees.position_target.consumers.append(
            self.move_position_b_only_to_action_destroyer__position_target
        )
        self.destruction_connection_action_destroyer_3 = tracing.DestructionConnection(
            self.scheduler,
            0,
            self.run_action_destroyer__position_target__action_destructor_b_2,
        )
        self.execution_action_destroyer_3 = local.my_domain_com.my_lib.destroyer.DestroyerExecution(
            self.action.on_particle.get_action(
                local.my_domain_com.my_lib.destroyer.Destroyer
        ...
        self.execution_action_destroyer_3.join_for_empty_rule_position_target = literal.NO_JOIN
        self.execution_action_destroyer_3.join_for_destroy_position_target = literal.NO_JOIN
        self.execution_action_destroyer_3.guarantees.position_target.consumers.append(
    ...
    def run_action_destroyer__position_target__action_destructor_a(self):
    ...
    def run_action_destroyer__position_target__action_destructor_b(self):
    ...
    def run_action_destroyer__position_target__action_destructor_a_2(self):
        execution = local.my_domain_com.my_lib.destructor_a.DestructorAExecution(
            self.scheduler,
            self.destruction_connection_action_destroyer_2.trace_execution,
            "destructor_a#2",
    ...
    def run_action_destroyer__position_target__action_destructor_b_2(self):
        execution = local.my_domain_com.my_lib.destructor_b.DestructorBExecution(
            self.scheduler,
