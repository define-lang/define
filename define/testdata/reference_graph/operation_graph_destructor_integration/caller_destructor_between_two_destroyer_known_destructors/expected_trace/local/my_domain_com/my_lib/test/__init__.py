...
class TestExecution:
    def __init__(
        ...
        self.join_for_trigger_position_destroyer_particle__action_destroyer__position_target__action_caller_destructor__when_empty_global_position_marker = literal.Join(2)
