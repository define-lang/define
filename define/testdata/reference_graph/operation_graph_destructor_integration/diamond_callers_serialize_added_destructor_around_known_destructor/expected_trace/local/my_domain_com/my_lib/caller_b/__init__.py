...
class CallerBExecution:
    def __init__(
        ...
        *,
        ...
        self.guarantees = CallerBGuarantees(self.scheduler)
    ...
    def move_position_carrier_to_position_destroyer_particle__action_destroyer__position_target(self):
        ...
        self.scheduler.continue_with(
            self.execution_position_destroyer_particle__action_destroyer.accept_for_empty_rule_position_target__global_position_marker,
