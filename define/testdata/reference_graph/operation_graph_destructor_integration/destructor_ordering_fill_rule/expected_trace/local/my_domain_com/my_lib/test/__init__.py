...
class TestExecution:
    def __init__(
        ...
        self.join_for_trigger_position_destroyer_particle__action_destroyer__position_target__action_extra_destructor__when_empty_global_position_marker = self.scheduler.create_join(2)
