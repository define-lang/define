...
class TestExecution:
    def __init__(
        ...
        self.join_for_trigger_position_destroyer_particle__action_destroyer__for_empty_rule_position_target__global_position_origin = literal.Join(2)
        self.join_for_trigger_position_destroyer_particle__action_destroyer__when_empty_position_target__global_position_destination = literal.Join(2)
        self.join_for_trigger_position_destroyer_particle__action_destroyer__when_occupied_position_target = literal.Join(2)
        self.join_for_trigger_position_destroyer_particle__action_destroyer__position_target__action_extra_destructor__for_empty_rule_global_position_origin = literal.Join(2)
