...
class TestExecution:
    ...
    def create_position_destroyer_particle(self):
        ...
        self.destruction_connection_position_destroyer_particle__action_destroyer = tracing.DestructionConnection(
            self.scheduler,
            1,
            self.position_destroyer_particle__action_destroyer__position_target__action_extra_destructor__when_empty_global_position_marker,
        )
        self.execution_position_destroyer_particle__action_destroyer = local.my_domain_com.my_lib.destroyer.DestroyerExecution(
        ...
        self.execution_position_destroyer_particle__action_destroyer.join_for_move_position_target_to_position_holder = literal.NO_JOIN
    ...
    def move_position_carrier_to_position_destroyer_particle__action_destroyer__position_target(self):
        ...
        self.execution_position_destroyer_particle__action_destroyer.accept_for_empty_rule_position_target()
    ...
    def position_destroyer_particle__action_destroyer__position_target__action_extra_destructor__when_empty_global_position_marker(self):
        self.execution_position_destroyer_particle__action_destroyer__position_target__action_extra_destructor.accept_when_empty_global_position_marker()
