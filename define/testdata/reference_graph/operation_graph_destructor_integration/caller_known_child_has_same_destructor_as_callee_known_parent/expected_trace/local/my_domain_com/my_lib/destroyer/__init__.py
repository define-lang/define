...
class DestroyerExecution:
    def __init__(
        ...
        *,
        ...
        self.execution_position_run__action_destructor: local.my_domain_com.my_lib.destructor.DestructorExecution
    ...
    def continue_when_occupied_position_run(self):
        self.execution_position_run__action_destructor.on_action_parent_occupied()
