...
class TestExecution:
    ...
    def create_position_carrier(self):
        ...
        self.execution_action_destroyer__position_target__action_second_destructor.join_for_empty_rule_global_position_second = literal.NO_JOIN
        self.execution_action_destroyer__position_target__action_second_destructor.join_for_move_global_position_second_to_position_holder = literal.NO_JOIN
