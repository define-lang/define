...
class Test(literal.EntryPoint):
    ...
    def execute(self, scheduler: literal.Scheduler):
        ...
        execution.join_for_position_destroyer_particle__action_destroyer__position_target__action_extra_destructor__for_empty_rule_global_position_shared = scheduler.create_join(2)
...
class TestExecution:
    def __init__(
        ...
        self.destruction_connection_position_destroyer_particle__action_destroyer_2: literal.DestructionConnection
    ...
    def create_position_destroyer_particle(self):
        ...
        self.destruction_connection_position_destroyer_particle__action_destroyer_2 = literal.DestructionConnection(
            self.scheduler,
            1,
            self.position_destroyer_particle__action_destroyer__position_target__action_extra_destructor__for_empty_rule_global_position_shared,
        )
        self.execution_position_destroyer_particle__action_destroyer = local.my_domain_com.my_lib.destroyer.DestroyerExecution(
            ...
            destruction_connections=literal.DestructionConnections(
            {
                ...
                local.my_domain_com.my_lib.destroyer.DestroyerExecution.continue_destroy_position_target__global_position_shared: self.destruction_connection_position_destroyer_particle__action_destroyer_2,
            },
            ),
        )
        self.execution_position_destroyer_particle__action_destroyer.join_for_empty_rule_position_target__global_position_shared = literal.NO_JOIN
        self.execution_position_destroyer_particle__action_destroyer.join_for_empty_rule_position_target = literal.NO_JOIN
        self.execution_position_destroyer_particle__action_destroyer.join_for_move_position_target__global_position_shared_to_position_holder = literal.NO_JOIN
    ...
    def move_position_carrier_to_position_destroyer_particle__action_destroyer__position_target(self):
        ...
        self.execution_position_destroyer_particle__action_destroyer__position_target__action_extra_destructor.join_for_empty_rule_global_position_shared = literal.NO_JOIN
        self.execution_position_destroyer_particle__action_destroyer__position_target__action_extra_destructor.join_for_move_global_position_shared_to_global_position_destination = literal.NO_JOIN
        self.execution_position_destroyer_particle__action_destroyer__position_target__action_extra_destructor.guarantees.global_position_destination__move__global_position_shared.consumers.append(
    ...
    def position_destroyer_particle__action_destroyer__position_target__action_extra_destructor__for_empty_rule_global_position_shared(self):
        if not self.join_for_position_destroyer_particle__action_destroyer__position_target__action_extra_destructor__for_empty_rule_global_position_shared.arrive():
            return
        self.execution_position_destroyer_particle__action_destroyer__position_target__action_extra_destructor.accept_for_empty_rule_global_position_shared()
