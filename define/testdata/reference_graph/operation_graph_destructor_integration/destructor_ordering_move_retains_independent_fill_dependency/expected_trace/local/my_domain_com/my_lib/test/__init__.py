...
class TestExecution:
    def __init__(
        ...
        self.join_for_trigger_position_destroyer_particle__action_destroyer__for_empty_rule_position_target__global_position_shared = self.scheduler.create_join(2)
        ...
        self.join_for_trigger_position_destroyer_particle__action_destroyer__position_target__action_extra_destructor__for_empty_rule_global_position_shared = self.scheduler.create_join(2)
    ...
    def move_position_carrier_to_position_destroyer_particle__action_destroyer__position_target(self):
        ...
        self.scheduler.submit(self.trigger_position_destroyer_particle__action_destroyer__for_empty_rule_position_target__global_position_shared)
    ...
    def create_position_destroyer_particle__action_destroyer__position_trigger_pos(self):
        ...
        self.execution_trigger_position_destroyer_particle__action_destroyer = local.my_domain_com.my_lib.destroyer.DestroyerExecution(
            ...
            destruction_connections=literal.DestructionConnections(
            {
                ...
                local.my_domain_com.my_lib.destroyer.DestroyerExecution.continue_destroy_position_target__global_position_shared: self.destruction_connection_trigger_position_destroyer_particle__action_destroyer_2,
            },
            ),
        )
    ...
    def trigger_position_destroyer_particle__action_destroyer__for_empty_rule_position_target__global_position_shared(self):
        if not self.join_for_trigger_position_destroyer_particle__action_destroyer__for_empty_rule_position_target__global_position_shared.arrive():
            return
        self.execution_trigger_position_destroyer_particle__action_destroyer.accept_for_empty_rule_position_target__global_position_shared()
    ...
    def trigger_position_destroyer_particle__action_destroyer__position_target__action_extra_destructor__for_empty_rule_global_position_shared(self):
        if not self.join_for_trigger_position_destroyer_particle__action_destroyer__position_target__action_extra_destructor__for_empty_rule_global_position_shared.arrive():
            return
        self.execution_trigger_position_destroyer_particle__action_destroyer__position_target__action_extra_destructor.accept_for_empty_rule_global_position_shared()
