...
class TestExecution:
    ...
    def create_global_action_runner__position_run(self):
        ...
        self.scheduler.submit(self.trigger_global_action_runner__when_empty_global_position_marker_a)
        self.trigger_global_action_runner__when_empty_global_position_marker_b()
    ...
    def trigger_global_action_runner__when_empty_global_position_marker_a(self):
        self.trigger_global_action_runner__execution.accept_when_empty_global_position_marker_a()

    def trigger_global_action_runner__when_empty_global_position_marker_b(self):
        self.trigger_global_action_runner__execution.accept_when_empty_global_position_marker_b()
