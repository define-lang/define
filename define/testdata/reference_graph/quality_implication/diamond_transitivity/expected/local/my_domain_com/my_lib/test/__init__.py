...
class TestExecution:
    ...
    def create_action_runner__position_run(self):
        ...
        self.scheduler.submit(self.trigger_action_runner__when_empty_position_source)
        self.scheduler.submit(self.trigger_action_runner__when_empty_position_dest)
        self.trigger_action_runner__for_empty_rule_position_run()

    def trigger_action_runner__when_empty_position_source(self):
        self.execution_trigger_action_runner.accept_when_empty_position_source()

    def trigger_action_runner__when_empty_position_dest(self):
        self.execution_trigger_action_runner.accept_when_empty_position_dest()
