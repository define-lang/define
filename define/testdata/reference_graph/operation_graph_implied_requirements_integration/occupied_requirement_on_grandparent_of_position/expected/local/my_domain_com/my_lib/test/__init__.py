...
class TestExecution:
    def __init__(
        ...
        self.join_for_trigger_global_action_triggered__for_empty_rule_position_input__global_position_child__global_position_grandchild = literal.Join(2)
    ...
    def create_global_action_triggered__position_input(self):
        ...
        self.trigger_global_action_triggered__for_empty_rule_position_input__global_position_child__global_position_grandchild()
    ...
    def trigger_global_action_triggered__for_empty_rule_position_input__global_position_child__global_position_grandchild(self):
        if not self.join_for_trigger_global_action_triggered__for_empty_rule_position_input__global_position_child__global_position_grandchild.arrive():
            return
        self.trigger_global_action_triggered__execution.accept_for_empty_rule_position_input__global_position_child__global_position_grandchild()
