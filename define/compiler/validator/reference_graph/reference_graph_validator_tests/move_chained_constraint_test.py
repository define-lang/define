    ...
    result = validate_project_with_reference_graph(
        {
            ...
            "test.dfn": (
                ...
                "        create a dimension point in position<src>::position</x>::position</y>.\n"
    ...
    result = validate_project_with_reference_graph(
        {
            ...
            "test.dfn": (
                ...
                "        }\n"
                "        create a dimension point in position<a>.\n"
                "        create a dimension point in position<a>::position</x>.\n"
                "        create a dimension point in position<a>::position</x>::position</y>.\n"
                "        create a dimension point in position<b>.\n"
                "        create a dimension point in position<b>::position</z>.\n"
