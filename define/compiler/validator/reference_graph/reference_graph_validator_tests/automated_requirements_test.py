...
def test_error_requirement_does_not_skip_later_unsatisfied_requirement(
    ...
    assert all_diags[1].location.end_line == 20
    ...
    assert all_diags[1].occupied_at.line == 19
    assert all_diags[1].occupied_at.column == 47
    assert all_diags[1].occupied_at.end_line == 19
    ...
    assert all_diags[2].location.line == 21
    assert all_diags[2].location.column == 30
    assert all_diags[2].location.end_line == 21
