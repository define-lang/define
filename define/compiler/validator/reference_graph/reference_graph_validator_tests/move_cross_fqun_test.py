    ...
    result = validate_project_with_reference_graph(
        {
            ...
            "test.def": (
                ...
                f"        }}\n"
                f"        create a dimension point in position<from_pos>.\n"
                f"        create a dimension point in position<dest>.\n"
    ...
    result = validate_project_with_reference_graph(
        {
            ...
            "test.def": (
                ...
                f"        create a dimension point in position<src>::position<{_CHILD}:/x>.\n"
    ...
    result = validate_project_with_reference_graph(
        {
            ...
            "test.def": (
                ...
                f"        }}\n"
                f"        create a dimension point in position<src>.\n"
                f"        create a dimension point in position<gateway>.\n"
                f"        move the dimension point in position<src> to position<gateway>::action<{_CHILD}:/act>::position<local_dest>.\n"
                f"    }}\n"
                f"}}\n"
            ),
        },
