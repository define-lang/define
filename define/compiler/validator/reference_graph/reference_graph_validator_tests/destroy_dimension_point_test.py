    ...
    result = validate_project_with_reference_graph(
        {
            ...
            "test.dfn": (
                ...
                "            }\n"
                "        }\n"
                "        destroy the dimension point in position<parent>::position</child_pos>.\n"
                "    }\n"
                "}\n"
            ),
        }
    ...
    result = validate_project_with_reference_graph(
        {
            ...
            "test.dfn": (
                ...
                "        create a dimension point in position<parent>::position</child_pos>.\n"
                "        destroy the dimension point in position<parent>.\n"
                "        move the dimension point in position<parent>::position</child_pos> to position<dest>.\n"
                "    }\n"
                "}\n"
            ),
        }
