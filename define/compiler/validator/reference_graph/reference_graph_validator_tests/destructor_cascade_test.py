    ...
    result = validate_project_with_reference_graph(
        {
            ...
            "test.dfn": (
                ...
                "        }\n"
                "        create a dimension point in position<box>.\n"
                "        create a dimension point in position<box>::action</inner>::position<slot_a>.\n"
                "        create a dimension point in position<box>::action</inner>::position<slot_b>.\n"
                "        create a dimension point in position<box>::action</inner>::position<slot_c>.\n"
                "        destroy the dimension point in position<box>.\n"
                "    }\n"
                "}\n"
            ),
    ...
    result = validate_project_with_reference_graph(
        {
            ...
            "test.dfn": (
                ...
                "        create a dimension point in position<box>.\n"
                "        create a dimension point in position<box>::position</child>.\n"
                "        create a dimension point in position<box>::position</child>::position</grandchild>.\n"
                "        destroy the dimension point in position<box>.\n"
                "    }\n"
                "}\n"
            ),
    ...
    result = validate_project_with_reference_graph(
        {
            ...
            "test.dfn": (
                ...
                "        }\n"
                "        create a dimension point in position<box>.\n"
                "        create a dimension point in position<box>::position</a_branch>.\n"
                "        create a dimension point in position<box>::position</a_branch>::position</a_leaf>.\n"
                "        create a dimension point in position<box>::position</b_branch>.\n"
                "        create a dimension point in position<box>::position</b_branch>::position</b_leaf>.\n"
                "        destroy the dimension point in position<box>.\n"
                "    }\n"
                "}\n"
            ),
...
def test_cascade_skips_unknown_position_own_destructor(
    ...
    result = validate_project_with_reference_graph(
        {
            ...
            "test.dfn": (
                ...
                "        create a dimension point in position<box>.\n"
                "        create a dimension point in position<box>::position</child>.\n"
                "        move the dimension point in position<box>::position</child> to position<box>::position</child>::position</noop>.\n"
                "        destroy the dimension point in position<box>.\n"
                "    }\n"
                "}\n"
            ),
    ...
    assert all_diags[0].location.column == 105
    ...
    result = validate_project_with_reference_graph(
        {
            ...
            "test.dfn": (
                ...
                "        create a dimension point in position<box>::position</child>.\n"
                "        create a dimension point in position<box>::position</child>::position</grandchild>.\n"
                "        move the dimension point in position<box>::position</child> to position<box>::position</child>::position</grandchild>.\n"
                "        destroy the dimension point in position<box>.\n"
                "    }\n"
                "}\n"
            ),
